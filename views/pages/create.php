        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center space-x-4 mb-4">
                    ...
                    <div class="bg-gradient-to-r from-emerald-500 to-green-500 rounded-full p-4 w-16 h-16 kids-shadow">
    ...
    <form action="/dashboard/pages" method="post" id="pageForm" class="space-y-8">
        ...
        <div class="bg-white kids-shadow rounded-2xl p-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Set up the fundamental details of your page</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 form-field">
                    ...
                    <input type="text"
                        name="title"
                        id="pageTitle"
                        placeholder="Enter your page title (e.g., About Us, Contact, Privacy Policy)"
                ...
                <div class="form-field">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Automatically generated from title. You can customize it if needed.</p>
                </div>
            ...
            <div class="grid md:grid-cols-1 gap-6">
                ...
                <div class="form-field">
                    ...
                    <textarea name="meta_description"
                        ...
                        class="w-full border-2 border-gray-200 rounded-xl p-4 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 transition-all duration-300 hover:border-indigo-300 resize-none"></textarea>
        ...
        <div class="bg-white kids-shadow rounded-2xl p-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Create your page content using the rich text editor</p>
            </div>
            ...
            <div class="form-field">
                ...
                <div class="border-2 border-gray-200 rounded-xl overflow-hidden focus-within:border-orange-400 focus-within:ring-2 focus-within:ring-orange-100 transition-all duration-300">
                    <textarea id="contentEditor"
                        ...
                        placeholder="Start writing your page content here..."></textarea>
                </div>
        ...
        <div class="bg-white kids-shadow rounded-2xl p-8">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                ...
                <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-3">
                    ...
                    <button type="submit"
                        class="bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 kids-shadow hover:shadow-lg flex items-center space-x-2">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border-l-4 border-blue-400">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    <p class="text-blue-800 font-semibold mb-2">💡 Page Creation Tips:</p>
                    <ul class="text-blue-700 text-sm space-y-1">
                        <li>• Choose a clear, descriptive title that explains the page purpose</li>
                        <li>• Write a compelling meta description to improve search rankings</li>
                        <li>• Use headings (H1, H2, H3) to structure your content properly</li>
                        <li>• Add images and links to make your content more engaging</li>
                        <li>• Preview your page before publishing to check formatting</li>
                    </ul>
                </div>
            </div>
        </div>
...
<script>
    ...
    function previewPage() {
        ...
        previewWindow.document.write(`
            ...
            <body>
                ...
                <p style="color: #666; font-size: 14px;"><em>This is a preview - page is not yet published</em></p>
            </body>
            </html>
        `);
    }
    ...
    document.getElementById('pageForm').addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner loading-spinner mr-2"></i>Creating Page...';
